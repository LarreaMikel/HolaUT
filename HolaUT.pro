...
UBUNTU_TRANSLATION_DOMAIN="holaut.larreamikel"
...
aptest.commands = bash $$PWD/HolaUT/tests/autopilot/run
aptest.depends  = sub-HolaUT

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/HolaUT/tests/unit 
unittest.depends  = sub-HolaUT
